"""
🎯 Sniper Bot - Versão Específica para Render
Bot otimizado especificamente para deploy no Render
"""
...
def run_telegram_bot_simple():
    """Executa o bot Telegram de forma simplificada"""
    ...
    try:
        ...
        # Executar polling de forma síncrona
...
def main():
    ...
    # Iniciar bot Telegram em thread separada (método simplificado)
    if TELEGRAM_AVAILABLE and config.get('TELEGRAM_TOKEN'):
        telegram_thread = Thread(target=run_telegram_bot_simple, daemon=True)
